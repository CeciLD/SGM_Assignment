...
public class ControllerMovementP4 : MonoBehaviour {
    ...
    void Movement()
    {
        ...
        if (Input.GetButtonDown("Player4LB") && grounded)
        {
        ...
        else
        {
            ...
            if (jumpsLeft > 0)
            {
                if (Input.GetButtonDown("Player4LB"))
                {
                    //canDoubleJump = false;
        ...
        float deltaX = Input.GetAxis("Player4LeftJoystickX") * horizontalSpeed;
        ...
        float rotateX = Input.GetAxis("Player4RightJoystickX");
        float rotateY = Input.GetAxis("Player4RightJoystickY");
    ...
    void Shooting()
    {
        if (Input.GetButton("Player4RB") && canShoot)
        {
