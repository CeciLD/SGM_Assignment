...
public class ControllerMovementP3 : MonoBehaviour {
    ...
    void Movement()
    {
        ...
        if (Input.GetButtonDown("Player3LB") && grounded)
        {
        ...
        else
        {
            ...
            if (jumpsLeft >0)
            {
                if (Input.GetButtonDown("Player3LB"))
                {
                    //canDoubleJump = false;
        ...
        float deltaX = Input.GetAxis("Player3LeftJoystickX") * horizontalSpeed;
        ...
        float rotateX = Input.GetAxis("Player3RightJoystickX");
        float rotateY = Input.GetAxis("Player3RightJoystickY");
    ...
    void Shooting()
    {
        if (Input.GetButton("Player3RB") && canShoot)
        {
